// /attendance/tosd — Time Off & Sick Days register
// (Moved out of the Leave module — TOSD is attendance data, not leave.)
//
...
export const Route = createFileRoute("/_authenticated/attendance/tosd")({
  component: TosdPage,
});
