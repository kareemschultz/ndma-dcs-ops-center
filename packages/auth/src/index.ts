...
const statement = {
  ...
  appraisal: ["create", "read", "update", "submit", "approve", "reject", "process"] as const,
  ...
  advance: ["create", "read", "update", "delete", "approve", "clear", "export"] as const,
...
export const managerRole = ac.newRole({
  ...
  contract: ["read"],
  appraisal: ["create", "read", "update", "submit", "approve", "reject", "process"],
  report: ["read"],
  audit: ["read"],
  settings: ["read"],
  ...
  leave_policy: ["read"],
  advance: ["create", "read", "update", "approve"],
});
...
export const personalAssistantRole = ac.newRole({
  ...
  appraisal: ["create", "read", "update", "submit", "process"],
  report: ["read"],
  audit: ["read"],
  settings: ["read"],
  ...
  ppe: ["create", "read", "update", "assign"],
  leave_policy: ["read"],
  advance: ["create", "read", "update", "approve", "clear"],
});
...
export const hrAdminOpsRole = ac.newRole({
  ...
  advance: ["create", "read", "update", "delete", "approve", "clear", "export"],
});
